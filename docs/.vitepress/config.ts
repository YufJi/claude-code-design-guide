...
export default defineConfig({
  ...
  rewrites: {
    ...
    'architecture/README_EN.md': 'en/architecture/README.md',
    'architecture/01-系统总览/system-overview-en.md': 'en/architecture/01-系统总览/system-overview.md',
    'architecture/02-启动与初始化/initialization-en.md': 'en/architecture/02-启动与初始化/initialization.md',
    'architecture/03-查询引擎/query-engine-en.md': 'en/architecture/03-查询引擎/query-engine.md',
    'architecture/04-API客户端/api-client-en.md': 'en/architecture/04-API客户端/api-client.md',
    'architecture/05-工具系统/tool-system-en.md': 'en/architecture/05-工具系统/tool-system.md',
    'architecture/06-权限与安全/permission-security-en.md': 'en/architecture/06-权限与安全/permission-security.md',
    'architecture/07-上下文管理/context-management-en.md': 'en/architecture/07-上下文管理/context-management.md',
    'architecture/08-MCP集成/mcp-integration-en.md': 'en/architecture/08-MCP集成/mcp-integration.md',
    'architecture/09-Hooks系统/hooks-system-en.md': 'en/architecture/09-Hooks系统/hooks-system.md',
    'architecture/10-Skills系统/skills-system-en.md': 'en/architecture/10-Skills系统/skills-system.md',
    'architecture/11-多智能体/multi-agent-en.md': 'en/architecture/11-多智能体/multi-agent.md',
    'architecture/12-UI渲染/ui-rendering-en.md': 'en/architecture/12-UI渲染/ui-rendering.md',
    'architecture/13-配置体系/config-system-en.md': 'en/architecture/13-配置体系/config-system.md',
    'architecture/14-状态管理/state-management-en.md': 'en/architecture/14-状态管理/state-management.md',
    'architecture/15-命令体系/command-system-en.md': 'en/architecture/15-命令体系/command-system.md',
    'architecture/16-记忆系统/memory-system-en.md': 'en/architecture/16-记忆系统/memory-system.md',
    'architecture/17-错误恢复/error-recovery-en.md': 'en/architecture/17-错误恢复/error-recovery.md',
    'architecture/18-遥测分析/telemetry-system-en.md': 'en/architecture/18-遥测分析/telemetry-system.md',
    'architecture/19-反馈与调查/feedback-system-en.md': 'en/architecture/19-反馈与调查/feedback-system.md',
    'architecture/20-服务层/services-complete-en.md': 'en/architecture/20-服务层/services-complete.md',
    'architecture/21-插件系统/plugin-system-en.md': 'en/architecture/21-插件系统/plugin-system.md',
    'architecture/22-OAuth与认证/oauth-auth-en.md': 'en/architecture/22-OAuth与认证/oauth-auth.md',
    'architecture/23-LSP集成/lsp-integration-en.md': 'en/architecture/23-LSP集成/lsp-integration.md',
    'architecture/24-沙箱系统/sandbox-system-en.md': 'en/architecture/24-沙箱系统/sandbox-system.md',
    'architecture/25-Git与GitHub/git-github-en.md': 'en/architecture/25-Git与GitHub/git-github.md',
    'architecture/26-会话管理/session-management-en.md': 'en/architecture/26-会话管理/session-management.md',
    'architecture/27-键绑定与输入/keybinding-system-en.md': 'en/architecture/27-键绑定与输入/keybinding-system.md',
    'architecture/28-Vim模式/vim-mode-en.md': 'en/architecture/28-Vim模式/vim-mode.md',
    'architecture/29-语音系统/voice-system-en.md': 'en/architecture/29-语音系统/voice-system.md',
    'architecture/30-远程会话/remote-session-en.md': 'en/architecture/30-远程会话/remote-session.md',
    'architecture/31-Bridge协议/bridge-protocol-en.md': 'en/architecture/31-Bridge协议/bridge-protocol.md',
    'architecture/32-Buddy系统/buddy-system-en.md': 'en/architecture/32-Buddy系统/buddy-system.md',
    'architecture/33-协调器模式/coordinator-mode-en.md': 'en/architecture/33-协调器模式/coordinator-mode.md',
    'architecture/34-Swarm系统/swarm-architecture-en.md': 'en/architecture/34-Swarm系统/swarm-architecture.md',
    'architecture/35-Computer-Use/computer-use-en.md': 'en/architecture/35-Computer-Use/computer-use.md',
    'architecture/36-DeepLink/deeplink-system-en.md': 'en/architecture/36-DeepLink/deeplink-system.md',
    'architecture/37-Teleport/teleport-system-en.md': 'en/architecture/37-Teleport/teleport-system.md',
    'architecture/38-输出样式/output-styles-en.md': 'en/architecture/38-输出样式/output-styles.md',
    'architecture/39-原生模块/native-modules-en.md': 'en/architecture/39-原生模块/native-modules.md',
    'architecture/40-迁移系统/migration-system-en.md': 'en/architecture/40-迁移系统/migration-system.md',
    'architecture/41-文件持久化/file-persistence-en.md': 'en/architecture/41-文件持久化/file-persistence.md',
    'architecture/42-代价追踪/cost-tracking-en.md': 'en/architecture/42-代价追踪/cost-tracking.md',
    'architecture/43-Shell工具链/shell-toolchain-en.md': 'en/architecture/43-Shell工具链/shell-toolchain.md',
    'architecture/44-Screens组件/screens-components-en.md': 'en/architecture/44-Screens组件/screens-components.md',
    'architecture/45-类型系统/type-system-en.md': 'en/architecture/45-类型系统/type-system.md',
    'architecture/46-完整数据流图/complete-data-flow-en.md': 'en/architecture/46-完整数据流图/complete-data-flow.md',
  },
